...
# Form implementation generated from reading ui file 'C:\Users\conta\Documents\script\Wizard\App\ui_files\exports_widget.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.exports_treeWidget = QtWidgets.QTreeWidget(self.exports_main_frame)
        self.exports_treeWidget.setAnimated(True)
        self.exports_treeWidget.setObjectName("exports_treeWidget")
        self.exports_treeWidget.header().setVisible(False)
        self.verticalLayout_2.addWidget(self.exports_treeWidget)
        ...
        self.exports_extension_frame = QtWidgets.QFrame(self.manual_publish_horizontalFrame)
        self.exports_extension_frame.setMaximumSize(QtCore.QSize(16777215, 48))
        self.exports_extension_frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.exports_extension_frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.exports_extension_frame.setObjectName("exports_extension_frame")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout(self.exports_extension_frame)
        self.horizontalLayout_2.setContentsMargins(18, 0, 0, 0)
        ...
        self.export_extension_icon_label = QtWidgets.QLabel(self.exports_extension_frame)
        self.export_extension_icon_label.setMinimumSize(QtCore.QSize(22, 22))
        self.export_extension_icon_label.setMaximumSize(QtCore.QSize(22, 22))
        self.export_extension_icon_label.setText("")
        self.export_extension_icon_label.setAlignment(QtCore.Qt.AlignBottom|QtCore.Qt.AlignHCenter)
        self.export_extension_icon_label.setObjectName("export_extension_icon_label")
        self.verticalLayout_3.addWidget(self.export_extension_icon_label)
        spacerItem3 = QtWidgets.QSpacerItem(0, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_3.addItem(spacerItem3)
        self.horizontalLayout_2.addLayout(self.verticalLayout_3)
        self.exports_extension_comboBox = QtWidgets.QComboBox(self.exports_extension_frame)
        self.exports_extension_comboBox.setMinimumSize(QtCore.QSize(120, 48))
        self.exports_extension_comboBox.setMaximumSize(QtCore.QSize(120, 48))
        self.exports_extension_comboBox.setObjectName("exports_extension_comboBox")
        self.horizontalLayout_2.addWidget(self.exports_extension_comboBox)
        self.horizontalLayout.addWidget(self.exports_extension_frame)
    ...
    def retranslateUi(self, Form):
        ...
        self.exports_treeWidget.headerItem().setText(0, _translate("Form", "1"))
