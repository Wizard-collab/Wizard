...
# Form implementation generated from reading ui file 'C:\Users\conta\Documents\script\wizard\App\gui\ui_files\shot_creation_dialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.shote_name_spinBox = QtWidgets.QSpinBox(self.shot_crea_main_frame)
        self.shote_name_spinBox.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.shote_name_spinBox.setMinimum(1)
        self.shote_name_spinBox.setMaximum(10000)
        self.shote_name_spinBox.setObjectName("shote_name_spinBox")
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.shote_name_spinBox)
