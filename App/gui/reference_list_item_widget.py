...
# Form implementation generated from reading ui file 'C:\Users\conta\Documents\script\Wizard\App\ui_files\reference_list_item_widget.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.reference_list_item_asset_stage_label = QtWidgets.QLabel(self.reference_list_item_frame)
        self.reference_list_item_asset_stage_label.setMinimumSize(QtCore.QSize(140, 0))
        self.reference_list_item_asset_stage_label.setMaximumSize(QtCore.QSize(140, 16777215))
        self.reference_list_item_asset_stage_label.setObjectName("reference_list_item_asset_stage_label")
        self.horizontalLayout.addWidget(self.reference_list_item_asset_stage_label)
        self.line_3 = QtWidgets.QFrame(self.reference_list_item_frame)
        ...
        self.ticket_reference_list_item_pushButton = QtWidgets.QPushButton(Form)
        self.ticket_reference_list_item_pushButton.setMinimumSize(QtCore.QSize(32, 32))
        self.ticket_reference_list_item_pushButton.setMaximumSize(QtCore.QSize(32, 32))
        ...
        self.horizontalLayout_3.addWidget(self.ticket_reference_list_item_pushButton)
        self.parameters_reference_list_item_pushButton = QtWidgets.QPushButton(Form)
        self.parameters_reference_list_item_pushButton.setMinimumSize(QtCore.QSize(32, 32))
        self.parameters_reference_list_item_pushButton.setMaximumSize(QtCore.QSize(32, 32))
        ...
        self.horizontalLayout_3.addWidget(self.parameters_reference_list_item_pushButton)
        self.refresh_reference_widget_item = QtWidgets.QPushButton(Form)
        self.refresh_reference_widget_item.setMinimumSize(QtCore.QSize(32, 32))
        self.refresh_reference_widget_item.setMaximumSize(QtCore.QSize(32, 32))
        self.refresh_reference_widget_item.setText("")
        self.refresh_reference_widget_item.setObjectName("refresh_reference_widget_item")
        self.horizontalLayout_3.addWidget(self.refresh_reference_widget_item)
        self.folder_reference_list_item_pushButton = QtWidgets.QPushButton(Form)
        self.folder_reference_list_item_pushButton.setMinimumSize(QtCore.QSize(32, 32))
        self.folder_reference_list_item_pushButton.setMaximumSize(QtCore.QSize(32, 32))
        ...
        self.horizontalLayout_3.addWidget(self.folder_reference_list_item_pushButton)
        self.remove_reference_widget_item = QtWidgets.QPushButton(Form)
        self.remove_reference_widget_item.setMinimumSize(QtCore.QSize(32, 32))
        self.remove_reference_widget_item.setMaximumSize(QtCore.QSize(32, 32))
        self.remove_reference_widget_item.setText("")
        self.remove_reference_widget_item.setObjectName("remove_reference_widget_item")
        self.horizontalLayout_3.addWidget(self.remove_reference_widget_item)
    ...
    def retranslateUi(self, Form):
        ...
        self.reference_list_item_asset_stage_label.setText(_translate("Form", "asset_stage"))
